<?php
	...
	if(isset($_POST["action"])&&($_POST["action"]=="delete")){
		$sql_query = "DELETE FROM `applyadvance` WHERE `id`=".$_POST["id"];
...
?>
	...
	<head>
		...
		<title>2018臺中世界花卉博覽會志工特殊教育訓練管理系統-刪除資料</title>
	...
	<body>
		<h1 class="text-center"><strong>2018臺中世界花卉博覽會志工特殊教育訓練管理系統-刪除資料</strong></h1>
		<h3 class="text-center"><a href="advance.php">回主畫面</a></h3>
		<div class="container">
			<div class="row">
				<br />
				<div class="col-lg-12">
