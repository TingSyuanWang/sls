<?php
	...
	$sql_query = "INSERT INTO testbasic (`surname`, `name`, `ensurname`, `enname`, `nationality`, `identification`, `gender`, `birthday`, `employment`, `education`, `phone`, `telephone`, `email`, `contacttime`, `emcontacter`, `emphone`, `emrelationship`, `language`, `servicenumber`, `volunteerexp`, `certification`, `gesture`, `skill`, `address`, `contactaddress`, `unit`, `position`, `food`, `event`) VALUES (";
